...
} elseif ( file_exists( "{$wpmu_plugin_dir}/{$ldb_dirname}/ludicrousdb.php" ) ) { // Check /mu-plugins/.
	require_once "{$wpmu_plugin_dir}/{$ldb_dirname}/ludicrousdb.php";
} elseif ( file_exists( "{$wpdb_plugin_dir}/{$ldb_dirname}/ludicrousdb.php" ) ) { // Check /db-plugins/.
